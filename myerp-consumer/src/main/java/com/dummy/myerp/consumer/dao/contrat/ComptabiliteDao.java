...
public interface ComptabiliteDao {
    ...
    int getValeurJournalComptableByFeatures(String codeJournal, int year) throws NotFoundException;

    void updateSequenceJournalComptable(String codeJournal, int year, int lastValeur) throws NotFoundException;

    boolean isJournalCodeExiste(String codeJournal);
